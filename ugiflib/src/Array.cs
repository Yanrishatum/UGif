...
namespace haxe.root {
	public sealed class Array<T> : global::haxe.lang.HxObject, global::haxe.root.Array {
		...
		protected static void __hx_ctor__Array<T_c>(global::haxe.root.Array<T_c> __hx_this, T_c[] native) {
			__hx_this.length = ( native as global::System.Array ).Length;
			__hx_this.__a = native;
		}
		
		
		protected static void __hx_ctor__Array<T_c>(global::haxe.root.Array<T_c> __hx_this) {
			__hx_this.length = 0;
