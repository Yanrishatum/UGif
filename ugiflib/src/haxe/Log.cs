...
namespace haxe {
	public class Log : global::haxe.lang.HxObject {
		...
		static Log() {
			global::haxe.Log.trace = ( (( global::haxe.Log_Anon_59__Fun.__hx_current != null )) ? (global::haxe.Log_Anon_59__Fun.__hx_current) : (global::haxe.Log_Anon_59__Fun.__hx_current = ((global::haxe.Log_Anon_59__Fun) (new global::haxe.Log_Anon_59__Fun()) )) );
		}
		...
		public static string formatOutput(object v, object infos) {
			...
			if (( ( infos != null ) && ( ((global::haxe.root.Array) (global::haxe.lang.Runtime.getField(infos, "customParams", 1830310359, true)) ) != null ) )) {
				int _g = 0;
...
#pragma warning disable 109, 114, 219, 429, 168, 162
namespace haxe {
	public class Log_Anon_59__Fun : global::haxe.lang.Function {
		
		public Log_Anon_59__Fun() : base(2, 0) {
		}
		
		
		public static global::haxe.Log_Anon_59__Fun __hx_current;
