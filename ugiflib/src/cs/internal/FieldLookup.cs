...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 104, 105, 111, 113, 120, 121, 3448988, 4745537, 4846113, 4849249, 4948692, 5144726, 5393365, 5398057, 5442204, 5546126, 5594513, 5594516, 10885262, 31706958, 38537191, 43737796, 46374763, 52596231, 57476627, 62867362, 76061764, 87367608, 89406858, 98812439, 103142179, 117802505, 134699147, 134699148, 146652910, 179047623, 206591766, 209784577, 212463405, 234855119, 240151589, 243225909, 279728799, 288167040, 301554636, 302979532, 311106773, 328878574, 359333139, 407283053, 452737314, 457536206, 478930593, 493819893, 501039929, 520590566, 542823803, 551993134, 555415130, 560337532, 601515549, 602753309, 610723709, 623891245, 640252688, 650414942, 669658758, 701242674, 706588918, 736935997, 746958758, 755457067, 772311838, 772773472, 782657381, 793759659, 808948541, 823259145, 853386981, 853386982, 897947994, 931066841, 946786476, 986695702, 995215424, 997273700, 1002555126, 1018258543, 1021542597, 1030456453, 1058556349, 1067353468, 1092025094, 1092171829, 1092820744, 1103412149, 1159105261, 1159640013, 1160494533, 1170195731, 1181037546, 1184833344, 1204816148, 1214453688, 1224901875, 1228056441, 1238832007, 1240041172, 1247572323, 1247875546, 1247983110, 1269254998, 1280845662, 1282943179, 1291439277, 1301734216, 1309344294, 1340130708, 1348037855, 1352786672, 1377802169, 1381630732, 1390579183, 1398464674, 1431819701, 1436822557, 1437450540, 1458549169, 1462163331, 1501088657, 1517549559, 1518649614, 1532710347, 1539378591, 1547539107, 1584738519, 1620824029, 1621420777, 1623148745, 1648581351, 1705629508, 1718617065, 1724357446, 1740766879, 1743811007, 1763375486, 1768617329, 1776869523, 1793650908, 1830310359, 1885347373, 1892534710, 1913956818, 1915412854, 1916009602, 1981972957, 1991808755, 2007273841, 2021592393, 2025055113, 2032764644, 2044981782, 2054707467, 2056138942, 2070785640, 2082663554, 2096228120, 2127021138};
		
		protected static string[] fields = new string[]{"b", "h", "i", "o", "q", "x", "y", "EOF", "__a", "add", "arr", "crc", "get", "len", "lzw", "map", "out", "pop", "pos", "codeSize", "charCellWidth", "height", "flush", "readAll", "masks", "getEnumConstructs", "compress", "remove", "filter", "textBackgroundColorIndex", "readBlock", "readPixels", "update", "pixelsX", "pixelsY", "globalColorTable", "readString", "pixelsCaret", "output", "pixels", "globalColorTableSize", "readImage", "readBytes", "freeEnt", "stream", "writeHeader", "methodName", "readUInt16", "iterator", "lastIndexOf", "hasNext", "reverse", "writeFrame", "readColorTable", "getBytes", "insert", "length", "bigEndian", "interlacingStage", "textGridHeight", "readBlocks", "writeAppExtension", "writeEOF", "writeFullBytes", "pixelAspectRatio", "writeString", "set_bigEndian", "blocks", "disposalMethod", "localColorTable", "backgroundColorIndex", "frames", "hasTransparentColor", "writeUInt16", "transparentIndex", "char_out", "colorTable", "sorted", "eofCode", "textGridX", "textGridY", "clearCode", "clearFlag", "toString", "blockBufferCaret", "minCodeSize", "cl_hash", "remaining", "colorResolution", "writeBlocks", "readApplicationExtension", "_eof", "splice", "bits", "blit", "byte", "copy", "htab", "codeSizeLimit", "writeLogicalScreenDescriptor", "item", "join", "writeComment", "concat", "close", "next", "enumConstructor", "writeByte", "writeGraphicControl", "color", "push", "width", "read", "sort", "quicksort", "text", "codetab", "readFullBytes", "writeUnknownExtension", "write", "spliceVoid", "gctSize", "writeBytes", "writeInt32", "getEnumName", "createEnumIndex", "createEnum", "writeText", "MAXCODE", "delay", "interlaced", "cl_block", "writeChunk", "concatNative", "charCellHeight", "className", "localColorTableSize", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "toDynamic", "bitsCount", "colbits", "textForegroundColorIndex", "userInput", "readByte", "allEnums", "nextPixel", "interlacingStep", "customParams", "blockBuffer", "writeStringBlocks", "deinterlace", "__get", "__set", "lineNumber", "textGridWidth", "flush_char", "readExtension", "unshift", "logicalScreenDescriptor", "encode", "enumParameters", "picture", "hasGlobalColorTable", "shift", "version", "slice"};
